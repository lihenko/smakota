              ...
              <Link
                ...
                >
                  ...
                  <div className="px-4 pt-4 pb-10">
                    <h2 className="text-lg font-semibold">Набір силіконового кухонного приладдя 19 предметів Фіолетовий Kitchen Set</h2>
                  </div>
                </Link>
              <Link
                ...
                >
                  ...
                  <div className="px-4 pt-4 pb-10">
                    <h2 className="text-lg font-semibold">Електрогриль Zepline ZP-820</h2>
                  </div>
                </Link>
                <Link
                ...
                >
                  ...
                  <div className="px-4 pt-4 pb-10">
                    <h2 className="text-lg font-semibold">Мультипекар 5в1, 600Вт, Sokany SK-08105</h2>
                  </div>
                </Link>
                <Link
                ...
                >
                  ...
                  <div className="px-4 pt-4 pb-10">
                    <h2 className="text-lg font-semibold">Тостер Crownberg CB 1106</h2>
                  </div>
                </Link>
                <Link
                ...
                >
                  ...
                  <div className="px-4 pt-4 pb-10">
                    <h2 className="text-lg font-semibold">Гейзерна кавоварка Edenberg EB-1815</h2>
                  </div>
                </Link>
            </div>
          </div>
