        ...
        <div className="flex flex-wrap -mx-3 mb-6">
          ...
          <div className="w-full lg:w-1/2 px-3 xl:pl-10">
            ...
            <div className="text-lg mb-4">
              Мангал Стандарт — міцний та надійний мангал для дому та виїздів на природу. Компактний та зручний у транспортуванні, він дозволяє рівномірно готувати м’ясо, рибу та овочі.
            </div>
            <div className="text-lg mb-4">
